...
%   input matrix representing the direction a passenger has to walk to
...
%% Uncomment line 43 if colormap-plot needed
% imageplot(A,'Distance to starting point');

%% Uncomment line 46-62 if vectorfield-plot needed
...
% y = 1:8:m;
% %   Plot Vectorfield
% quiver(x, y, VFX(1:8:m,1:8:n), VFY(1:8:m, 1:8:n));
% 
